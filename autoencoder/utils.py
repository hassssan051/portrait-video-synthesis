...
def extract_subset_vector(vector):
    ...
    output_vector.extend(vector[5:6]) # c_lip
...
def extract_subset_vector_exp_lip(vector):
...
def extract_subset_vector_xs_lip(vector):

    output_vector = []
    output_vector.extend(vector[5:6]) # c_lip
    output_vector.extend(vector[76:139]) # exp
...
def map_subset_to_full_vector(full_vector, subset_output):
    c_eyes = subset_output[:2]
    c_lip = subset_output[2:3]
    t = subset_output[3:6]
    rpy = subset_output[6:9]
    exp = subset_output[9:]
    full_vector[3:5] = c_eyes
    full_vector[5:6] = c_lip
    full_vector[7:10] = t
    full_vector[10:13] = rpy
